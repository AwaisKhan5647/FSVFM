# Fine-tuning FS-VFM ViT-L/16 for DfD and Testing on unseen DiFF
...
FINETUN_DATA_PATH='../../../datasets/finetune_datasets/deepfakes_detection/FaceForensics/32_frames/DS_FF++_each_cls/c23/DeepFakes'
OUTPUT_DIR='./checkpoint/finetuned_models/ViT-L_VF2_600e/FT_on_FF++_DF_c23_32frames'
...
CUDA_VISIBLE_DEVICES=5,6 OMP_NUM_THREADS=1 python -m torch.distributed.launch \
    ...
    --finetune_data_path "$FINETUN_DATA_PATH" \
